...
class TestBalanceMetrics:
    ...
    def test_calculate_balance_stats(self, unbalanced_data, balanced_data):
        ...
        expected_columns = [
            'variable', 'smd_before', 'smd_after', 'var_ratio_before', 'var_ratio_after'
        ]
        ...
        assert (abs(balance_df['var_ratio_after'] - 1) < abs(balance_df['var_ratio_before'] - 1)).mean() > 0.5
    ...
    def test_calculate_rubin_rules(self, unbalanced_data, balanced_data):
        ...
        expected_keys = [
            'n_variables_total', 'n_smd_small', 'pct_smd_small',
            'n_var_ratio_good', 'pct_var_ratio_good', 'n_both_good', 'pct_both_good'
        ]
        ...
        assert rubin_metrics['pct_smd_small'] > unbalanced_rubin_metrics['pct_smd_small']
    ...
    def test_calculate_balance_index(self, unbalanced_data, balanced_data):
        ...
        # Check that the function returns the expected keys
        expected_keys = [
            'mean_smd_before', 'mean_smd_after', 'max_smd_before', 'max_smd_after',
            'mean_balance_ratio', 'max_balance_ratio', 'n_variables_improved',
            'pct_variables_improved', 'balance_index'
        ]
        for key in expected_keys:
    ...
    def test_calculate_overall_balance(self, unbalanced_data, balanced_data):
        ...
        expected_keys = [
            'mean_smd_before', 'mean_smd_after', 'max_smd_before', 'max_smd_after',
            'prop_balanced_before', 'prop_balanced_after', 'mean_reduction',
            'mean_reduction_percent', 'percent_balanced_improved'
        ]
        for key in expected_keys:
        ...
        assert overall_balance['prop_balanced_after'] > overall_balance['prop_balanced_before']
